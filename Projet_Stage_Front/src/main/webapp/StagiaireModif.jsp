...
<%
    ...
    String id_encadr = String.valueOf(stagiaire.getEncadrant().getId());
    String id_stage = String.valueOf(stagiaire.getStage().getId());
                        ...
                        <form id="Encadrant-form" method="post" action="StagiaireServlet">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input type="number" id="idEncadrant" name="id_encadr" value="<%=id_encadr%>" required>
                            </div>
                               <div class="form-group">
                                <label for="idStage">ID Stage:</label>
                                <input type="number" id="idStage" name="id_stage" value="<%=id_stage%>" required>
